...
fun FirstLevelScreenThree(
    ...
    Box(modifier = Modifier
        ...
        FirstScreenContent(
            navController = navController,
            topBarText = "Level 3",
            questionText = "Qual das seguintes opções se aplica a Noer?",
            imgSrcQuestion = R.drawable.first_level_quiestion_3,
            model = quizViewModel.firstLevelModelList[2]
        ) {
            navController.navigate(Screen.FirstLevelFourth.route)
        }
    }
