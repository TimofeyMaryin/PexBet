...
fun FirstLevelScreenFour(
    ...
    Box(modifier = Modifier
        ...
        FirstScreenContent(
            navController = navController,
            topBarText = "Level 4",
            questionText = "Qual das seguintes opções não se aplica a Messi?",
            imgSrcQuestion = R.drawable.first_level_quiestion_4,
            model = quizViewModel.firstLevelModelList[3]
        ) {
            navController.navigate(Screen.FirstLevelFife.route)
        }
    }
