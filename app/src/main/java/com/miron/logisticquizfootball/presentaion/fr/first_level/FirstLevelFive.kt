...
fun FirstLevelScreenFive(
    ...
    Box(modifier = Modifier
        ...
        FirstScreenContent(
            navController = navController,
            topBarText = "Level 5",
            questionText = "Qual das seguintes opções não se aplica a Ronaldo?",
            imgSrcQuestion = R.drawable.first_level_quiestion_5,
            model = quizViewModel.firstLevelModelList[4]
        ) {
